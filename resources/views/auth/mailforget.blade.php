            ...
            <td align="center"
                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            <img src="https://envobyte.com/social/envobyte-logo-light.png"
                                                style="height: 50px;padding: 20px 0px; margin-left: -8px; padding-left: 0px;"
                                                alt="">
                                            <h1 style="margin-top: 0; color: #0A2C8C; font-size: 32px; font-weight: bold; text-align: left;"
                                                align="left">Change Your Password</h1>
               ...
               https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                                            role="presentation">
                                                            <tr>
                                                                <p>You have receieve a password chnage request for your
                                                                    Enobyte account</p>
                                                                <p>If You did not ask to change your password then you
                                                                    can ignore this email and your password will
                                                                    not be changed.The link will remain active for 25
                                                                    hours.
                                                                </p>
                                                            </tr>
                                                        </table>
               ...
               https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <a target="_blank"
                                                                        href="{{ route('reset.password', $token) }}"
                                                                        class="submit_button"
